                ...
                <div className="relative md:p-1 w-full flex flex-col gap-4 items-start">
                    ...
                    <div className="z-50 w-full">
                        <p
                            ...
                            } text-3xl md:absolute md:top-41 md:m-0 mt-4 max-w-5xl sm:text-4xl md:text-[5rem] font-semibold leading-[100%] tracking-tight text-white`}
                        >
                    ...
                    <div
                        className={`transition-all duration-700 delay-200 ease-out transform ${
                            isMounted
                                ? 'translate-y-0 opacity-100 pointer-events-auto'
                                : 'translate-y-8 opacity-0 pointer-events-none'
                        } lg:mt-16 mt-8 flex flex-col md:flex-row items-center md:items-start gap-8 md:gap-8 w-full max-w-4xl`}
                    >
                        {/* CTA Button */}
