...
const HomeFeatures = () => {
    ...
    return (
        <>
            <section className="relative bg-[#efefef] px-6 md:px-8 py-[10rem] overflow-hidden">
                <div className="relative z-10">
                    <div className="text-xs uppercase font-medium text-neutral-600 px-2 md:px-8 tracking-widest">
                        Features • Features • Features
                    </div>

                    <h2 className="mt-12 text-3xl md:text-5xl max-w-xl tracking-tighter font-medium px-2 md:px-8">
                    ...
                    <div className="mt-20 flex flex-col gap-6">
                        {features.map((feature, i) => (
                            <div
                                ...
                                className={clsx(
                                    'transition-colors duration-700 ease-in-out z-20  md:[clip-path:polygon(0%_0%,calc(100%-110px)_0%,100%_110px,100%_100%,0%_100%)]',
                            ...
                            >
                                <div className={clsx("flex gap-16 border  flex-wrap md:flex-nowrap items-center gap-x-16 gap-y-6  px-6 md:px-8 py-16 md:py-22 md:[clip-path:polygon(0%_0%,calc(100%-110px)_0%,100%_110px,100%_100%,0%_100%)]",
                                    visibleIndexes.includes(i)
                                        ? 'bg-white border-none'
                                        : 'border-[#babbbd] bg-[#efefef]'
                                )}>
                                    <div className="flex flex-wrap items-center gap-8 flex-1 min-w-[280px]">
                                        ...
                                        <div className="flex flex-col gap-4 justify-center text-left">
                                            ...
                                            <h4 className={clsx("text-3xl leading-[100%] tracking-tighter font-semibold ",
                                                visibleIndexes.includes(i)
                                                    ? 'text-black/80'
                                                    : 'text-[#BABBBD]'
                                            )}>
                                        ...
                                        <p className="text-base max-w-[27.3rem] leading-[100%] text-black/80 mx-auto md:mx-10">
                                            {feature.description}
                                        </p>
                                    </div>
            ...
            <section className="relative border-t border-[#babbbd]/50 bg-[#efefef] px-6 md:px-8 py-[10rem] overflow-hidden">
                <div className="relative flex justify-between">
                    <div>
                        ...
                        <div className="mt-12 text-3xl md:text-5xl max-w-xl tracking-tighter font-medium px-2 md:px-8">
                            <h2 className="text-4xl font-semibold leading-[100%] tracking-tight text-black">
                                It just clicks <br /> with your stack
                            </h2>
                        </div>
                    </div>
                    <div className="grid grid-cols-1 z-10 md:grid-cols-2 gap-8">
                        {gridfeatures.map((feature, index) => (
                            <div
                                key={index}
                                className={`
                border border-neutral-200 p-12 w-[28rem] bg-white md:[clip-path:polygon(0%_0%,calc(100%-80px)_0%,100%_110px,100%_100%,0%_100%)]
                ${index === 2 ? 'md:col-span-2 w-[58rem] flex flex-col lg:flex-row gap-8 items-center' : 'flex flex-col items-center md:items-start text-center md:text-left'}
            `}
                            >
